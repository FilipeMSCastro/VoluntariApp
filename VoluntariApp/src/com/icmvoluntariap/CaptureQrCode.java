 ...
 */
public class CaptureQrCode extends DecoderActivity {

	private static final String TAG = CaptureQrCode.class.getSimpleName();
	...
	private void handleDecodeInternally(Result rawResult,
		...
		qrCode.putExtra("qrCode", displayContents.toString());
		setResult(RESULT_OK, qrCode);
		finish();
	}
